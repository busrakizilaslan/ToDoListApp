package com.busrayalcin.todolistapp.data.entity
...
data class Task (@PrimaryKey(autoGenerate = true)
                 ...
                 @ColumnInfo(name = "task_date") @NotNull var task_date:String,
                 @ColumnInfo(name = "task_time") @NotNull var task_time:String) : Serializable {
}